...
if (this.props.counter < 4) {
    ...
    return (
      ...
      <g>
        <circle fill='white' cx={this.props.circle.cx} cy={this.props.circle.cy} r={this.props.circle.r}/>
          <circle cx={this.props.leftEye.cx} cy={this.props.leftEye.cy + 20} r={this.props.leftEye.r}/>
          <circle cx={this.props.rightEye.cx} cy={this.props.rightEye.cy + 30} r={this.props.rightEye.r}/>
      </g>
