  ...
  render() {
    ...
    return (
      <g>
        ...
        <polygon points={`${this.props.circle.cx} ${this.props.circle.cy},${this.props.circle.cx + 1.2 * this.props.circle.r} ${this.props.circle.cy + 0.2 * this.props.circle.r}, ${this.props.circle.cx} ${this.props.circle.cy + 0.3 * this.props.circle.r}`}/>
